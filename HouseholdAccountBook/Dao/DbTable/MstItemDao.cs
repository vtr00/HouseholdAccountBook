...
namespace HouseholdAccountBook.Dao.DbTable
{
    ...
    /// 項目テーブルDAO
    /// </summary>
    public class MstItemDao : PrimaryKeyDaoBase<MstItemDto, int>
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        /// <param name="dbHandler">DBハンドラ</param>
        public MstItemDao(DbHandlerBase dbHandler) : base(dbHandler) { }
...
new { ItemId1 = itemId1, ItemId2 = itemId2, ConstValue.ConstValue.Updater });
