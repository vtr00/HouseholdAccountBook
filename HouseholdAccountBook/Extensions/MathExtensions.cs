...
namespace HouseholdAccountBook.Extensions
{
    ...
    public static class MathExtensions
    {
        ...
        public static int Gcd(int value1, int value2)
        {
            ...
            static int LocalGcd(int x, int y) => y == 0 ? x : LocalGcd(y, x % y);
            return value1 > value2 ? LocalGcd(value1, value2) : LocalGcd(value2, value1);
        }
        ...
        public static int Lcm(int value1, int value2) => (int)Math.Abs(value1 * ((double)value2 / Gcd(value1, value2)));
    }
}
