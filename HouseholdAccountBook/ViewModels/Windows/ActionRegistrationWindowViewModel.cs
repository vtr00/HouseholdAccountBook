...
namespace HouseholdAccountBook.ViewModels.Windows
{
    ...
    public class ActionRegistrationWindowViewModel : WindowViewModelBase
    {
        ...
        /// 帳簿変更時イベント
        /// </summary>
        public event EventHandler<EventArgs<int?>> BookChanged = default;
        /// <summary>
        /// 日時変更時イベント
        /// </summary>
        public event EventHandler<EventArgs<DateTime>> DateChanged = default;
        /// <summary>
        /// 収支変更時イベント
        /// </summary>
        public event EventHandler<EventArgs<BalanceKind>> BalanceKindChanged = default;
        /// <summary>
        /// 分類変更時イベント
        /// </summary>
        public event EventHandler<EventArgs<int?>> CategoryChanged = default;
        /// <summary>
        /// 項目変更時イベント
        /// </summary>
        public event EventHandler<EventArgs<int?>> ItemChanged = default;
        ...
        public DateTime SelectedDate
        {
            ...
            set {
                if (this.SetProperty(ref this._SelectedDate, value)) {
                    this.DateChanged?.Invoke(this, new EventArgs<DateTime>(value));
        ...
        protected async void ContinueToOKCommand_Executed()
        {
            ...
            using (WaitCursorManager wcm = this.waitCursorManagerFactory.Create()) {
                id = await this.RegisterActionInfoAsync();
            }
        ...
        public override Rect WindowRectSetting
        {
            set {
                ...
                if (settings.App_IsPositionSaved) {
                    settings.ActionRegistrationWindow_Left = value.Left;
                    settings.ActionRegistrationWindow_Top = value.Top;
                }
        ...
        public override Size? WindowSizeSetting
        {
            get {
                Properties.Settings settings = Properties.Settings.Default;
                return WindowSizeSettingImpl(settings.ActionRegistrationWindow_Width, settings.ActionRegistrationWindow_Height);
            }
        }
        ...
        public override Point? WindowPointSetting
        {
            get {
                Properties.Settings settings = Properties.Settings.Default;
                return WindowPointSettingImpl(settings.ActionRegistrationWindow_Left, settings.ActionRegistrationWindow_Top, settings.App_IsPositionSaved);
            }
        }
        #endregion
        ...
        private async Task UpdateItemListAsync(int? itemId = null)
        {
            ...
            await using (DbHandlerBase dbHandler = await this.dbHandlerFactory.CreateAsync()) {
                ...
                var dtoList = this.SelectedCategoryVM.Id == -1
                    ...
                    : await categoryItemInfoDao.FindByBookIdAndCategoryIdAsync(this.SelectedBookVM.Id.Value, (int)this.SelectedCategoryVM.Id);
        ...
        private async Task UpdateShopListAsync(string shopName = null)
        {
            ...
            string selectedShopName = shopName ?? this.SelectedShopName ?? shopNameVMList[0].Name;
            ...
            this.ShopVMList = shopNameVMList;
        ...
        public async Task LoadActionInfoAsync(int? selectedBookId, DateTime? selectedMonth, DateTime? selectedDate, CsvViewModel selectedRecord, int? selectedActionId)
        {
        ...
        private async Task<int?> RegisterActionInfoAsync()
        {
