...
namespace HouseholdAccountBook.Views.Windows
{
    ...
    public partial class ActionRegistrationWindow : Window
    {
        ...
        /// </summary>
        private readonly CsvViewModel selectedRecord;
        /// <summary>
        ...
        public ActionRegistrationWindow(DbHandlerFactory dbHandlerFactory, int selectedBookId, CsvViewModel selectedRecord)
        {
            this.dbHandlerFactory = dbHandlerFactory;
            this.selectedBookId = selectedBookId;
