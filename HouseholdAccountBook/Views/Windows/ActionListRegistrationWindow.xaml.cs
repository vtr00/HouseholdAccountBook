...
namespace HouseholdAccountBook.Views.Windows
{
    ...
    public partial class ActionListRegistrationWindow : Window
    {
        ...
        /// </summary>
        private readonly List<CsvViewModel> selectedRecordList;
        /// <summary>
        ...
        public ActionListRegistrationWindow(DbHandlerFactory dbHandlerFactory, int selectedBookId, List<CsvViewModel> selectedRecordList)
        {
            this.dbHandlerFactory = dbHandlerFactory;
            this.selectedBookId = selectedBookId;
            ...
            switch (this.WVM.RegMode) {
                case RegistrationKind.Add: {
                    ...
                    if (this.selectedRecordList == null) {
                        ...
                        foreach (CsvViewModel record in this.selectedRecordList) {
